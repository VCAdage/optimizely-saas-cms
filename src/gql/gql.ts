 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "fragment SearchPageData on SearchPage {\n  metadata: _metadata {\n    published\n  }\n  Image {\n    ...ReferenceData\n  }\n  Title\n}"): (typeof documents)["fragment SearchPageData on SearchPage {\n  metadata: _metadata {\n    published\n  }\n  Image {\n    ...ReferenceData\n  }\n  Title\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query searchArticles($pageSize: Int, $skip: Int, $searchTerm: String) {\n  ArticlePage(\n    limit: $pageSize\n    skip: $skip\n    where: {_fulltext: {match: $searchTerm}}\n    orderBy: {_ranking: SEMANTIC}\n  ) {\n    total\n    items {\n      ...IContentData\n      _metadata {\n        published\n      }\n      articleHeroImage {\n        ...ReferenceData\n      }\n      articleTitle\n      articleSummary {\n        html\n      }\n      articleBody {\n        html\n      }\n    }\n  }\n}"): (typeof documents)["query searchArticles($pageSize: Int, $skip: Int, $searchTerm: String) {\n  ArticlePage(\n    limit: $pageSize\n    skip: $skip\n    where: {_fulltext: {match: $searchTerm}}\n    orderBy: {_ranking: SEMANTIC}\n  ) {\n    total\n    items {\n      ...IContentData\n      _metadata {\n        published\n      }\n      articleHeroImage {\n        ...ReferenceData\n      }\n      articleTitle\n      articleSummary {\n        html\n      }\n      articleBody {\n        html\n      }\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "fragment AlertElementData on AlertElement {\n  AlertDescription\n  AlertTitle\n}"): (typeof documents)["fragment AlertElementData on AlertElement {\n  AlertDescription\n  AlertTitle\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
