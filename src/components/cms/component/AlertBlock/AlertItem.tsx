...
export const AlertItem = ({ size, className }: Props): JSX.Element => {
  return (
    <div
      className={`flex items-start justify-end gap-2 px-28 py-4 relative bg-alert-palettealert-general rounded-lg overflow-hidden ${className}`}
    >
